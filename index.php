...
<body>
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container">
      <img src="mal2.jpg" width="7%" alt="">
      <a class="navbar-brand" href="#">KUPAL KA BA?</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a href="b" class="btn btn-malup">KUPAL</a>
      </div>
    </div>
  </nav>
  ...
  <div class="banner d-flex align-items-center">
    <div class="container">
      <div class="col-lg-12">
        ...
        <h1 class="text-center">KAMUSTA ANG BUHAY-BUHAY?</h1>
       
        <p class="text-center">hahahahaha</p>
      ...
      <div class="row row-cols-lg-3">
        <div class="col d-flex justify-content-center">
          <div class="card" style="width: 24rem;">
            <img src="test-drive.png" class="card-img-top mx-auto" alt="...">
        ...
        <div class="col d-flex justify-content-center">
          <div class="card" style="width: 24rem;">
            <img src="repairing-service.png" class="card-img-top mx-auto" alt="...">
            <div class="card-body text-center">
              <h5 class="card-title">Card Title</h5>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                content.</p>
        ...
        <div class="col d-flex justify-content-center">
          <div class="card" style="width: 24rem;">
            <img src="customer-service.png" class="card-img-top mx-auto" alt="...">
            <div class="card-body text-center">
              <h5 class="card-title">Card Title</h5>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                content.</p>
